...
export default function ProfilePage() {
  ...
  const handleAddAllergy = (e: KeyboardEvent<HTMLInputElement>) => {
  ...
  const handleAddDislike = (e: KeyboardEvent<HTMLInputElement>) => {
                  ...
                  <TabsContent value="preferences" className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="allergies" className="flex items-center  text-gray-700">
                        <AlertTriangle className="mr-2 h-4 w-4 text-blue-600" /> Allergies
                      </Label>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="dislikes" className="flex items-center text-gray-700">
                        <ThumbsDown className="mr-2 h-4 w-4 text-blue-600" /> Dislikes
                      </Label>
                      <div className="flex flex-wrap gap-2 mb-2">
